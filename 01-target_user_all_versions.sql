...
prompt "SASH user will be created"
...
create user sash identified by sash default tablespace &SASH_TS temporary tablespace temp;
...
grant select on gv_$instance to sash;
...
grant select on gv_$sysstat to sash;
grant select on v_$system_event to sash;
grant select on gv_$system_event to sash;
grant select on v_$sysmetric_history to sash;
grant select on gv_$sysmetric_history to sash;
grant select on v_$con_sysmetric_history to sash;
grant select on gv_$con_sysmetric_history to sash;
grant select on v_$iostat_function to sash;
grant select on v_$sqlstats to sash;
grant select on gv_$sqlstats to sash;
grant select on v_$event_histogram to sash;
grant select on gv_$event_histogram to sash;
grant select on v_$sys_time_model to sash;
grant select on gv_$sys_time_model to sash;
grant select on v_$osstat to sash;
grant select on gv_$osstat to sash;

prompt "SASHNOW view will be created in SYS schema."
DECLARE
    l_ver VARCHAR2(10);
BEGIN
    SELECT
